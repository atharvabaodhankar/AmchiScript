  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <header className="w-full py-8 flex flex-col items-center gap-2">
        ...
        {/* Remove dark/light mode toggle button */}
      </header>
        ...
        <div className="flex flex-col md:flex-row gap-4 items-stretch">
          <div className="flex-1 flex flex-col gap-2">
            <div className="flex items-center gap-2 mb-1">
              ...
              <select
                className="ml-auto px-2 py-1 rounded border text-sm bg-gray-800 text-white border-gray-700 focus:outline-none"
            ...
            <textarea
              className="w-full min-h-[20rem] max-h-[40rem] p-3 rounded-lg border font-mono text-base shadow focus:outline-none focus:ring-2 focus:ring-yellow-400 transition resize-y bg-gray-900 border-gray-700 text-yellow-100"
              value={code}
            ...
            <div className="flex gap-2 mt-2">
              <button
                className={`flex-1 py-2 rounded-lg font-bold text-lg shadow transition-colors duration-200 ${waitingForInput ? 'opacity-60 cursor-not-allowed' : 'bg-yellow-400 text-gray-900 hover:bg-yellow-300'}`}
                onClick={runCode}
          ...
          <div className="flex-1 flex flex-col gap-2">
            ...
            <div className="flex-1 min-h-[20rem] max-h-[40rem] overflow-y-auto rounded-lg p-3 font-mono text-base whitespace-pre shadow border bg-gray-950 border-gray-700 text-green-200"
            ...
            {waitingForInput && (
              <form onSubmit={handleInputSubmit} className="flex gap-2 mt-2">
                <input
                  name="input"
                  className="flex-1 border rounded-lg p-2 font-mono text-base focus:outline-none focus:ring-2 bg-gray-900 border-yellow-400 text-yellow-100 focus:ring-yellow-400"
                  placeholder="Enter input..."
                  autoFocus
                  autoComplete="off"
                />
                <button className="px-4 py-2 rounded-lg font-bold transition-colors duration-200 bg-yellow-400 text-gray-900 hover:bg-yellow-300" type="submit">
                  Submit
                </button>
              </form>
            )}
